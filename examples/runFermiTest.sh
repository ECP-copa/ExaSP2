...
#export OMP_NUM_THREADS=16;./bin/ExaSP2-serial --hmatName data/nm.200.last.mtx --N 00 --M 00  --bndfil 0.63157894736842102 --beta 0.92552875303437621  --nsteps 18 --occLimit 1e-5
