...
export OMP_NUM_THREADS=16;./bin/ExaSP2-serial --hmatName data/nm.200.last.mtx --N 3800 --M 3800 --bndfil 0.63157894736842102 --beta 0.90663935914396565 --nsteps 18 --occLimit 1e-5
